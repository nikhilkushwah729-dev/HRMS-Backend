...
export class AnnouncementSchema extends BaseModel {
  static $columns = ['id', 'orgId', 'title', 'content', 'target', 'targetId', 'publishedAt', 'expiresAt', 'createdBy', 'deletedAt', 'createdAt'] as const
...
export class SocialLoginSchema extends BaseModel {
  static $columns = ['id', 'employeeId', 'provider', 'providerUserId', 'profileData', 'createdAt', 'lastLoginAt'] as const
...
export class TimesheetApprovalLogSchema extends BaseModel {
  static $columns = ['id', 'timesheetId', 'orgId', 'employeeId', 'actorEmployeeId', 'action', 'note', 'createdAt'] as const
  $columns = TimesheetApprovalLogSchema.$columns
  @column({ isPrimary: true })
  declare id: number
  @column()
  ...
  declare employeeId: number
  @column()
  declare actorEmployeeId: number | null
  @column()
  declare action: string
  @column()
