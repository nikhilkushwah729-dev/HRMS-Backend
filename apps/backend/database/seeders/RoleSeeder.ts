    ...
    const roles = [
      {
        id: 1,
        org_id: null,
        role_name: 'Tum (Super Admin)',
        description: 'App Owner with full global control across all organizations.',
        is_system: true,
        priority: 1,
        is_active: true,
        parent_role_id: null,
      ...
      },
      {
        id: 2,
        org_id: null,
        role_name: 'HR Manager (Admin)',
        description: 'Organization administrator managing employees, attendance, and payroll within their company.',
        is_system: true,
        priority: 2,
        is_active: true,
        parent_role_id: 1,
